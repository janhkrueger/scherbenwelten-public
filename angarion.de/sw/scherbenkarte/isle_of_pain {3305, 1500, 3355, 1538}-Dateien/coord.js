...
var winX = ((ns6)?(-12):(-15));   //Koordinatenkorrektur: erste Zahl für  Mozilla/Firefox und Netscape, zweite für Internet Explorer
var winY = ((ns6)?(-11):(-18));   //************************************************************************************************
...
function t(xMap,yMap,cText, nPos, cColor, cStyle)
{
	...
	//document.write("<div STYLE=\"cursor:pointer; text-align:center; position:absolute; left:"+xWin+"px; top:"+yWin+"px;\"><table onClick=\"captureCoord()\" onMousemove=\"showCoord()\"><tr><td width=\"120\" align=\"center\"><font color=\""+((cColor)?cColor:"#FF0000")+"\" size=\"-1\"><b>"+cText+"</b></font></td></tr></table></div>");	//z-index:2;
	document.write("<div STYLE=\"cursor:pointer; position:absolute; left:"+xWin+"px; top:"+yWin+"px;\"><table onClick=\"captureCoord()\" onMousemove=\"showCoord()\"><tr><td style=\"width:"+tWidth+"px; text-align:center; color:"+((cColor)?cColor:"#FF0000")+"; font-size:"+Math.min(8, zoom-2)+"pt;"+((cStyle)?cStyle:"")+"\">"+cText+"</td></tr></table></div>");	//z-index:2;
}
...
function t2(xMap,yMap,cText, nSize, cClass)
{
	...
	document.write("<div class=\""+cClass+"\" STYLE=\"cursor:pointer; position:absolute; left:"+xWin+"px; top:"+yWin+"px;\"><table class=\""+cClass+"\" onClick=\"captureCoord()\" onMousemove=\"showCoord()\"><tr><td style=\"width:"+tWidth+"px; text-align:center; font-size:"+nSize+"pt;\">"+cText+"</td></tr></table></div>");	//z-index:2;
}
